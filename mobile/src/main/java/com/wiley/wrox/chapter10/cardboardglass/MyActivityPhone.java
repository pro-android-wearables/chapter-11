...
public class MyActivityPhone extends CardboardActivity implements CardboardView.StereoRenderer {

    private GoogleApiClient mGoogleApiClient;

    BroadcastReceiver resultReceiver;

    private static final String TAG = "wrox-mobile";
     ...
     * to render our scene. It also creates the connection to the Wearable API
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // declaration of the Google API client
        ...
        LocalBroadcastManager.getInstance(this).registerReceiver(
                resultReceiver,
                new IntentFilter("cardboard.localIntent"));
    ...
    private void onWearTouch() {
        Log.v(TAG, "Arrived touch event");
    ...
    private BroadcastReceiver createBroadcastReceiver() {
        // we are just interested in the event, the rest doesn't matter
